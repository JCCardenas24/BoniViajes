                ...
                <div>
                    <div class="slider fullscreen" data-interval="false">
                        <ul class="slides">
                            ...
                            <li>
                                <img src="./assets/images/boni/Slides/grandvelas_loscabos@2x.png" alt="nobu">
                            </li>
                            <li>
                                <img src="./assets/images/boni/Slides/nobu_loscabos@2x.png" alt="tgmp">
                            </li>
                            <li>
                                <img src="./assets/images/boni/Slides/Secrets_Bahia_Mita_Surf___SPA_hotel@2x.png" alt="tgmp">
                            </li>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mt-20-card">
                                ...
                                <div class="b_pack rows pre-15">
                                    <div class="col-md-12 col-sm-12 p-15 text-center">
                                        ...
                                        <p class="c-red fs-20">$8,231*<span class="fs-20">/Noche</span></p>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mt-20-card">
                                ...
                                <div class="b_pack rows pre-15">
                                    <div class="col-md-12 col-sm-12 p-15 text-center">
                                        ...
                                        <small class="c-red f-15">Desde</small>
                                        <p class="c-red fs-20">$24,152*<span class="fs-20">/Noche</span></p>
                                        <a href="#main" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 form-desktop">Llámame</a>
                                        <a href="#formRes" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 d-mobile">Llámame</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mt-20-card">
                                ...
                                <div class="b_pack rows pre-15">
                                    <div class="col-md-12 col-sm-12 p-15 text-center">
                                        ...
                                        <small class="c-red f-15">Desde</small>
                                        <p class="c-red fs-20">$4,811*<span class="fs-20">/Noche</span></p>
                                        <a href="#main" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 form-desktop">Llámame</a>
                                        <a href="#formRes" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 d-mobile">Llámame</a>
                                    </div>
                                </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row row_promos p-15">
                            <div class="col-md-4 col-sm-6 col-xs-12 mt-20-card">
                                ...
                                <div class="b_pack rows pre-15">
                                    <div class="col-md-12 col-sm-12 p-15 text-center">
                                        ...
                                        <small class="c-red f-15">Desde</small>
                                        <p class="c-red fs-20">$11,533*<span class="fs-20">/Persona</span></p>
                                        <a href="#main" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 form-desktop">Llámame</a>
                                        <a href="#formRes" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 d-mobile">Llámame</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mt-20-card">
                                ...
                                <div class="b_pack rows pre-15">
                                    <div class="col-md-12 col-sm-12 p-15 text-center">
                                        ...
                                        <small class="c-red f-15">Desde</small>
                                        <p class="c-red fs-20">$9,513*<span class="fs-20">/Persona</span></p>
                                        <a href="#main" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 form-desktop">Llámame</a>
                                        <a href="#formRes" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 d-mobile">Llámame</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mt-20-card">
                                ...
                                <div class="b_pack rows pre-15">
                                    <div class="col-md-12 col-sm-12 p-15 text-center">
                                        ...
                                        <small class="c-red f-15">Desde</small>
                                        <p class="c-red fs-20">$8,446*<span class="fs-20">/Persona</span></p>
                                        <a href="#main" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 form-desktop">Llámame</a>
                                        <a href="#formRes" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 d-mobile">Llámame</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mt-20-card">
                                ...
                                <div class="b_pack rows pre-15">
                                    <div class="col-md-12 col-sm-12 p-15 text-center">
                                        ...
                                        <small class="c-red f-15">Desde</small>
                                        <p class="c-red fs-20">$11,366*<span class="fs-20">/Persona</span></p>
                                        <a href="#main" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 form-desktop">Llámame</a>
                                        <a href="#formRes" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 d-mobile">Llámame</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mt-20-card">
                                ...
                                <div class="b_pack rows pre-15">
                                    <div class="col-md-12 col-sm-12 p-15 text-center">
                                        ...
                                        <small class="c-red f-15">Desde</small>
                                        <p class="c-red fs-20">$17,761*<span class="fs-20">/Persona</span></p>
                                        <a href="#main" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 form-desktop">Llámame</a>
                                        <a href="#formRes" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 d-mobile">Llámame</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12 mt-20-card">
                                ...
                                <div class="b_pack rows pre-15">
                                    <div class="col-md-12 col-sm-12 p-15 text-center">
                                        <h4 class="text-uppercase f-medium f-res-20">Dreams Huacutlco</h4>
                                        <small class="c-red f-15">Desde</small>
                                        <p class="c-red fs-20">$5,403*<span class="fs-20">/Persona</span></p>
                                        <a href="#main" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 form-desktop">Llámame</a>
                                        <a href="#formRes" class="btn col-md-12 col-xs-12 btn-yellow white-text mb-10 radius-0 f-bold mb-0 txt-cap p-15 d-mobile">Llámame</a>
                                    </div>
                                </div>
